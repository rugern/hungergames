...
const STRINGS = {
  en: {
    ...
    mission: "We hunt the hiding team. We seek the delicacies of the Netherlands. We are always hungry.",
    ...
    feedError: "The news could not be loaded. The hiding team is suspected of sabotage.",
    tabMemes: "News",
    tabTour: "Tour",
  ...
  nl: {
    ...
    mission: "Wij jagen op het verstopte team. Wij zoeken de lekkernijen van Nederland. Wij hebben altijd honger.",
    ...
    feedError: "Het nieuws kon niet geladen worden. Het verstopte team wordt verdacht van sabotage.",
    tabMemes: "Nieuws",
    tabTour: "Tournee",
